<%@ Page Language="vb" AutoEventWireup="false" Inherits="ImageMapWebVB.DefaultPage" CodeFile="Default.aspx.vb" %>
		...
		<tr>
			...
			<td style="width: 25%; text-align: center;">
				...
				<ewsi:ImageMap ID="imClickMap" runat="server" ToolTip="Click an area to post back"
					ImageUrl="Images/PostBack.jpg" CausesValidation="True" onmouseover="javascript: IM_ShowHideText(true);"
